// =============================================================================
// tb_onnx_reduce.cpp - Reduce engine test for Graph Mode
...
// Helpers
// =============================================================================
static std::string g_datadir = "build/graph_reduce";
...
int main(int argc, char** argv) {
    ...
    printf("=== ONNX Reduce Engine Test ===\n");
