// =============================================================================
// tb_onnx_batchnorm_pool.cpp - BatchNorm+Pool test for Graph Mode
// Exercises multiple engine types. Loads program/tdesc/ddr_image from files,
// runs graph pipeline, handles DMA transfers in C++, compares output against
// golden.
// =============================================================================
#include <cstdio>
#include <cstdlib>
...
// Helpers
// =============================================================================
static std::string g_datadir = "build/graph_bn_pool";
...
int main(int argc, char** argv) {
    ...
    printf("=== ONNX BatchNorm+Pool Test ===\n");
    ...
    dut->trace(tfp, 99);
    tfp->open("onnx_batchnorm_pool.vcd");
