// =============================================================================
// tb_onnx_slice_concat.cpp - Slice+Concat engine test for Graph Mode
...
// Helpers
// =============================================================================
static std::string g_datadir = "build/graph_slice_concat";
...
int main(int argc, char** argv) {
    ...
    printf("=== ONNX Slice+Concat Engine Test ===\n");
    ...
    dut->trace(tfp, 99);
    tfp->open("onnx_slice_concat.vcd");
